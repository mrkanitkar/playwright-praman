...
6. ISSUE 4: Add `screenshot-patterns.md` (20 min)
7. ISSUE 10: Normalize output paths in agents (10 min)
8. Suggestion 3: Create `.claude/prompts/` files (20 min)

**Optional (Sprint 2+):**
9. ISSUE 7, 8, 9: Browser bind, screencast, CLI commands
