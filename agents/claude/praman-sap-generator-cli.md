...
| Concept              | Detail                                                                   |
| -------------------- | ------------------------------------------------------------------------ |
| Open browser         | `playwright-cli -s=gen open <url> --persistent --config=praman-cli.json` |
...
3. **Open a persistent browser session**:
   ...
   ```bash
   playwright-cli -s=gen open https://sap-system.example.com/sap/bc/ui5_ui5/ui2/ushell/shells/abap/FioriLaunchpad.html --persistent --config=praman-cli.json
   ```
...
11. **Type-check the generated file**:
    ...
    ```bash
    npx tsc --noEmit tests/e2e/{app}-{scenario}.spec.ts
    ```

12. **Lint the generated file**:

    ```bash
    npx eslint tests/e2e/{app}-{scenario}.spec.ts
    ```
