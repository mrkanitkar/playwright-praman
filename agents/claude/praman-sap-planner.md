...
1. Read `node_modules/playwright-praman/skills/playwright-praman-sap-testing/SKILL.md` — 7 mandatory rules, fixture lookup
2. Read `node_modules/playwright-praman/skills/playwright-praman-sap-testing/ai-quick-reference.md` — copy-paste patterns
3. Read `node_modules/playwright-praman/skills/playwright-praman-sap-testing/test-template.ts` — gold-standard examples
