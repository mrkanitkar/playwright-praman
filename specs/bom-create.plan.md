...
SAP S/4HANA Cloud - Maintain Bill of Material (Version 2) application. Fiori Elements V4 List Report with Create BOM dialog. URL: https://my403147.s4hana.cloud.sap/ui#MaterialBOM-maintainMaterialBOM. UI5 Version: 1.142.4. System: Partner Demo Customizing LXG/100. Controls use MDC field types (sap.ui.mdc.field.FieldInput), not classic SmartFields.
