...
| **G21** | **Static method signatures for only 12 controls**   | **🟡 Medium** | **Auto-generate or dynamic lookup (D22)**                                                 |
...
| D22 | **Auto-generated method signatures** — v2.5.0 `COMMON_METHOD_SIGNATURES` is hardcoded for only 12 control types. v3.0 auto-generates from SAP UI5 `api.json` metadata at build time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Scales to all 500+ UI5 controls. AI agents get complete method signatures, not just top 12.                                                                                                                                                                                                                                                                                                                                                                                                                                                  | 2025-02-15                                                                                                                                                                                                                                                                                          |
...
Test Code
  ...
  │         │    └─ .getView()  →  proxy-converter detects Control → returns UI5ControlProxy
...
| Auto-generated method signatures | Build-time generator from `api.json`                                     | Coverage > 12 hardcoded controls                     | D22      |
...
- D22: Auto-generated signatures — scales from 12 hardcoded to 500+ UI5 controls
