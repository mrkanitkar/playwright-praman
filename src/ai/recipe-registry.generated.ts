...
export const GENERATED_RECIPES: readonly RecipeEntry[] = [
  {
    ...
    "name": "Button Click",
    "description": "Press a UI5 button by matching its text property. Supports both explicit control acquisition with press() and the shorthand click() helper.",
    "domain": "ui5",
    "priority": "essential",
    "capabilities": [
      "UI5-UI5-001",
    ...
    "pattern": "import { test, expect } from 'playwright-praman';\n\n// Explicit: acquire the control, then press\nconst btn = await ui5.control({ controlType: 'sap.m.Button', properties: { text: 'Save' } });\nawait btn.press();\n\n// Shorthand\nawait ui5.click({ controlType: 'sap.m.Button', properties: { text: 'Save' } });"
  },
  {
    "id": "recipe-ui5-input-fill",
    "name": "Input Fill",
    "description": "Fill a UI5 input field by ID. Always call setValue(), fireChange(), and waitForUI5() to ensure the model binding is updated. The shorthand fill() helper bundles all three steps.",
    "domain": "ui5",
    "priority": "essential",
    "capabilities": [
      "UI5-UI5-001",
  ...
  },
  {
    ...
    "description": "Select an item in a sap.m.ComboBox by opening the dropdown, setting the selected key, firing the change event, then closing and waiting for UI5 to stabilize.",
    "domain": "ui5",
    "priority": "essential",
    "capabilities": [
      "UI5-UI5-001",
  ...
  },
  {
    ...
    "description": "Read rows, row count, and full data from a UI5 table by its ID. Use these helpers to inspect table contents in assertions or to drive data-dependent test logic.",
    "domain": "table",
    "priority": "essential",
    "capabilities": [
      "UI5-TABLE-002",
  ...
  },
  {
    ...
    "description": "Click a specific row in a UI5 table by its zero-based index. Triggers navigation or selection depending on the table mode.",
    "domain": "table",
    "priority": "essential",
    "capabilities": [
      "UI5-TABLE-014"
  ...
  },
  {
    ...
    "name": "Table Find Row",
    "description": "Locate a table row by matching column values. Returns the zero-based row index that can be passed to clickRow() or used in assertions.",
    "domain": "table",
    "priority": "essential",
    "capabilities": [
      "UI5-TABLE-012"
  ...
  },
  {
    ...
    "description": "Wait for, confirm, or dismiss UI5 dialogs. Controls inside dialogs REQUIRE the searchOpenDialogs option to be found by the bridge.",
    "domain": "dialog",
    "priority": "essential",
    "capabilities": [
      "UI5-DLG-001",
  ...
  },
  {
    ...
    "name": "FLP Navigation",
    "description": "Navigate to a Fiori Launchpad tile by its visible title. Waits for UI5 to stabilize after navigation.",
    "domain": "navigate",
    "priority": "essential",
    "capabilities": [
      "UI5-NAV-002",
  ...
  },
  {
    ...
    "description": "Navigate directly to a Fiori app via semantic object, intent hash, or search. Bypasses the tile-click workflow when the target hash is known.",
    "domain": "navigate",
    "priority": "essential",
    "capabilities": [
      "UI5-NAV-001",
  ...
  },
  {
    ...
    "name": "Date Picker",
    "description": "Set and read date values from sap.m.DatePicker and sap.m.DateRangeSelection controls. Dates use ISO 8601 format (YYYY-MM-DD).",
    "domain": "date",
  ...
  },
  {
    ...
    "name": "OData Query",
    "description": "Query an OData service for entities, wait for pending requests, and check for unsaved changes. Supports standard OData system query options ($filter, $top, $select, etc.).",
    "domain": "odata",
    "priority": "recommended",
    "capabilities": [
      "UI5-ODATA-010",
  ...
  },
  {
    ...
    "description": "Playwright expect() extended with UI5-aware matchers for text, visibility, enabled state, properties, value state, row count, and cell text.",
    "domain": "assert",
    "priority": "recommended",
    "capabilities": [
      "UI5-ASSERT-001",
  ...
  },
  {
    ...
    "description": "High-level intent API for business operations. Core intents map to individual UI actions; domain intents compose multiple steps into a single business operation.",
    "domain": "intent",
    "priority": "recommended",
    "capabilities": [
      "UI5-INTENT-001",
  ...
  },
  {
    ...
    "name": "Page Discovery",
    "description": "Use the AI fixture to discover the current page structure, list all available capabilities, or filter capabilities by category. Useful for dynamic test generation and self-healing agents.",
    "domain": "ai",
    "priority": "optional",
    "capabilities": [
      "UI5-AI-001",
