...
const LICENSE_TEXT = `                                 Apache License
   ...
   Copyright 2024-2026 Maheshwar Kanitkar (support@zestest.in)
...
export default function License(): ReactNode {
  return (
    <Layout title="License" description="Apache License 2.0">
      <main style={{ maxWidth: 800, margin: '0 auto', padding: '4rem 2rem' }}>
        ...
        <div style={{
          ...
          <pre style={{
            ...
            fontSize: '0.84rem', color: '#0f172a', lineHeight: 1.6,
          }}>
            {LICENSE_TEXT}
          </pre>
        </div>
