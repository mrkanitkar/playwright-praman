  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        // ── Menu 6: Example Prompts --
        {
          to: '/blog/tags/example-prompts',
          position: 'left',
          label: 'Example Prompts',
        },
        // ── Menu 7: Documentation ──
        {
          type: 'docSidebar',
        ...
        // ── Menu 8: API Reference (auto-generated by TypeDoc) ──
        {
          to: '/docs/api',
          position: 'left',
          label: 'API Reference',
        },
        // ── Menu 9: TypeDoc API (standalone HTML) ──
        {
